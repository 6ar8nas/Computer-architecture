...
.stack 100h
.data
    authorMessage DB 'The application processes interrupts (int 01h), identifying command INC/DEC r/m.', 10, 13, 10, 13, '$'
    commandFound DB 'Interrupt triggered!', 10, 13, '$'
    colon DB ':$'
    space DB ' $'
    comma DB ', $'
    incText DB ' INC $'
...
interrupt:
    ...
    ; we check if it's either of INC 1111 111w mod 000 r/m [offset] or DEC 1111 111w mod 001 r/m [offset]
    checkOPCode:
        PUSH AX
        AND AL, 0FEh
        CMP AL, 0FEh
    ...
    checkaddrByte:
        ...
        JE setINCVal
        PUSH AX
        AND AH, 38h             ; 1111 111w mm00 1rrr
        CMP AH, 8h              ;           0011 1000
        POP AX
        JE setDECVal
        JMP return
