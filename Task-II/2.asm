...
.data
    ...
    help             DB 'The application performs bitwise AND on two binary numbers of arbitrary length, reading them from different files.$'
    successMessage   DB 'The program has succeeded without any errors. Look for the results in a file by the name of $'
.code
